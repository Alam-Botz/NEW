...
exports.cecanmenu = (gayamenu, prefix) => {
return`*⌜ Cecan Menu ⌟* 
${gayamenu} ${prefix}randomcecan
${gayamenu} ${prefix}cecan
`
}
exports.nsfwmenu = (gayamenu, prefix) => {
return`*⌜ Nsfw Menu ⌟* 
...
exports.convertermenu = (gayamenu, prefix) => {
...
exports.hiburanmenu = (gayamenu, prefix) => {
return`*⌜ Hiburan Menu ⌟*
...
exports.groupmenu = (gayamenu, prefix) => {
return`*⌜ Group Menu ⌟*    
...
${gayamenu} ${prefix}hidetag *teks/reply teks*
